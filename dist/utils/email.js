...
exports.adminApprovalRequestEmail = adminApprovalRequestEmail;
exports.adminApprovedEmail = adminApprovedEmail;
exports.adminDeniedEmail = adminDeniedEmail;
...
function adminApprovalRequestEmail(userName, userEmail) {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
function adminApprovedEmail(userName) {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
function adminDeniedEmail(userName) {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
function emailVerificationEmail(verifyUrl) {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
